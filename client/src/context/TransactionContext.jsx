...
export const TransactionProvider = ({children}) => {
   ...
   return (
      <TransactionContext.Provider value={{connectWallet, currentAccounts, formData, handleChange, sendTransaction, transactions, isLoading}}>
         {children}
